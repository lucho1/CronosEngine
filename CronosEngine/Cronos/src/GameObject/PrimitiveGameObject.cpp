...
namespace Cronos {
	...
	// --------------------------------- PRIMITIVE MODEL ---------------------------------
	PrimitiveGameObject::PrimitiveGameObject(PrimitiveType primitve_type, glm::vec3 size, glm::vec3 position, const std::string& name, float radius, int figure_slices, int figure_stacks)
