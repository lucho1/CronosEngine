...
const TextEditor::Palette & TextEditor::GetDarkPalette()
{
	const static Palette p = { {
			...
			0xFF66AE58, // Comment (single line)
			0xFF66AE58, // Comment (multi line)
...
const TextEditor::Palette& TextEditor::GetDeactivatedPalette() 
{
	const static Palette p = { {
			0xFF9D9D9D,	// Default
			0xFF9D9D9D,	// Keyword	
			0xFF9D9D9D,	// Number
			0xFF9D9D9D,	// String
			0xFF9D9D9D, // Char literal
			0xFF9D9D9D, // Punctuation
			0xFF9D9D9D,	// Preprocessor
			0xFF9D9D9D, // Identifier
			0xFF9D9D9D, // Known identifier
			0xFF9D9D9D, // Preproc identifier
