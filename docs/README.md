...
From there, you will be able to assign any shader to any material and prepare yourself to do lots of things with shaders. Cronos Engine uses Shaders to support the Illumination and Material system!

But also, in addition, we have created a Water Shader so you can see an amazing Water Simulation fully calculated in the Shader and with the parameters of the water modifiable from the water material, so you can play with it! We invite you to check it out!
